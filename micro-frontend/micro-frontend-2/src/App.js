        ...
        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 border border-collapse ">
          ...
          <tbody>
            {countries.map((item, index) => (
              ...
              >
                <td className="px-6 py-4 font-normal">{item?.name?.common}</td>
                <td className="px-6 py-4 font-normal">{item?.capital}</td>
                <td className="px-6 py-4 font-normal">{item?.continents}</td>
                <td className="px-6 py-4 font-normal">{item?.population}</td>
